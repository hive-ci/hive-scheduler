...
ActiveRecord::Schema.define(version: 20_170_315_110_114) do
  ...
  add_index 'fields', %w[owner_id owner_type], name: 'index_fields_on_owner_id_and_owner_type', using: :btree
  ...
  add_index 'hive_queues_workers', %w[hive_queue_id worker_id], name: 'index_hive_queues_workers_on_hive_queue_id_and_worker_id', unique: true, using: :btree
  ...
  add_index 'jobs', %w[state job_group_id], name: 'index_jobs_on_state_and_job_group_id', using: :btree
  ...
  add_index 'workers', %w[hive_id pid device_id], name: 'index_hive_id_pid_on_workers', using: :btree
end
