    ...
    describe 'class methods' do
      ...
      describe '.requires' do
        ...
        let(:stored_dependencies) do
          klass.dependencies.each_with_object({}) do |dependency, stored_dependencies|
      ...
      describe '.provides' do
        ...
        context 'array of execution variables provided' do
          let(:execution_variables) { %i[queues tests] }
      ...
      describe '.execution_variables_required' do
        let(:required_fields) do
          klass.execution_variables_required.each_with_object({}) do |required_field, required_fields|
            required_fields[required_field.name] = required_field.field_type
          end
        end

        let(:expected_fields) do
          expected_raw_fields.each_with_object({}) do |(name, attributes), expected_fields|
